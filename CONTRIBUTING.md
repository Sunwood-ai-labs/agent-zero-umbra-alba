...
Thank you for helping improve Agent Zero: Umbra Alba.
...
4. Follow the setup guide in the [documentation](https://sunwood-ai-labs.github.io/agent-zero-umbra-alba/guide/getting-started).
