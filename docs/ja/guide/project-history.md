...
会話の仕組みを確認できた段階で、実行中のスケジューラーとSNSスキルから交流件数の目安を撤去しました。当初は20体へ`twin-moon-basin`の物理的前提だけを渡し、役割、制度、固定された勝利指標、操作ノルマを外部から与えませんでした。現在は競争層を加え、相手文明を上回るという地平だけを共有しています。何を優越と呼ぶかは競争憲章会議で議論し、中立のGMが場面、台帳、裁定を管理しますが、人物ごとの行動、口調、同盟、拒否は自律したままです。
