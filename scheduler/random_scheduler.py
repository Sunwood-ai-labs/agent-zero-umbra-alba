...
PROMPT = (
    ...
    "misskey-socialで最近のタイムラインに加えて、history --limit 20で自分自身の直近の新規投稿と"
    ...
    "サイクルの最後にbuilt-in memoryを必ず点検してください。今回のサイクルで長期的に必要な変化があれば、"
    "memoryツールで同じサイクル内に更新してください。保存対象は、確定した観察、自分の未完の約束、"
